  ...
  p-4 shadow-lg sm:w-[100%] m-auto   h-[500px] bg-cover flex flex-col justify-center"
      ...
      <div className="mb-6 flex flex-col gap-4 w-full px-6">
        <button
          ...
          className="text-white bg-BloodOrange py-3 rounded-lg font-bebas font-semibold hover:scale-105 transition-transform duration-300 sm:w-full md:w-96 md:m-auto sm:text-2xl"
        >
          Se Alla Events
        </button>
      </div>
