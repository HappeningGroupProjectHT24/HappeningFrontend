    ...
    return (
        <div className="flex flex-col justify-between bg-Flesh border border-gray-200 rounded-lg shadow dark:purpleDark dark:border-gray-700 h-[25rem] w-full m-1">
            ...
            <div className="flex-1 p-1 overflow-hidden pl-4">
                ...
                {/* button div */}
                <div >
                    <button onClick={handleDetailsClick} href="#" className="inline-flex items-center px-3 py-2 text-sm font-quicksand font-medium text-center text-white bg-DarkPurple rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:purpleContrast dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Detaljer
